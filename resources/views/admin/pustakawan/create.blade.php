...
<body class="bg-amber-100 font-sans min-h-screen relative">
  ...
  <div class="p-6 pt-24 max-w-md mx-auto">
    <h1 class="text-xl font-semibold text-gray-800 mb-5 text-center">Tambah Pustakawan</h1>

    <div class="bg-white p-5 rounded-lg shadow-md border border-gray-200">
      <form action="{{ route('pustakawan.store') }}" method="POST" class="space-y-3 text-sm">
        @csrf

        <div>
          <label class="block text-gray-700 font-medium text-xs">Nama</label>
          <input type="text" name="nama_pustaka" class="w-full px-2 py-1 border rounded text-xs focus:outline-none focus:ring-1 focus:ring-amber-300" required>
        </div>
        ...
        <div>
          ...
          <input type="text" name="no_tlp_pustaka" class="w-full px-2 py-1 border rounded text-xs focus:outline-none focus:ring-1 focus:ring-amber-300" required>
        </div>

        <div>
          <label class="block text-gray-700 font-medium text-xs">Alamat</label>
          <textarea name="alamat_pustaka" rows="2" class="w-full px-2 py-1 border rounded text-xs focus:outline-none focus:ring-1 focus:ring-amber-300" required></textarea>
        </div>
