{{-- resources/views/pustakawan/buku/create.blade.php --}}
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
    ...
    <div class="bg-white p-5 rounded-lg shadow-md border border-gray-200">
      <form method="POST" action="{{ route('buku.store') }}" enctype="multipart/form-data" class="space-y-3 text-sm">
        ...
        <div>
          ...
          <input type="text" name="judul_buku" class="w-full px-2 py-1 border rounded text-xs focus:outline-none focus:ring-1 focus:ring-amber-300" required>
        </div>
        ...
        <div>
          ...
          <input type="text" name="penulis" class="w-full px-2 py-1 border rounded text-xs focus:outline-none focus:ring-1 focus:ring-amber-300" required>
        </div>

        <div>
          <label class="block text-gray-700 font-medium text-xs">Penerbit</label>
          <input type="text" name="penerbit" class="w-full px-2 py-1 border rounded text-xs focus:outline-none focus:ring-1 focus:ring-amber-300" required>
        </div>
